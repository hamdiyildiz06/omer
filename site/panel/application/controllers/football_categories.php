...
class Football_categories extends HY_Controller
{
    public $viewFolder = "";
    ...
    public function __construct()
    {
        ...
        $this->viewFolder = "football_categories_v";
    ...
    public function index(){
        ...
        $items = $this->football_category_model->get_all(
            array()
        );
    ...
    public function save(){
        ...
        if($validate){
            ...
            redirect(base_url("football_categories"));
    ...
    public function update_form($id){
        ...
        /** Tablodan Verilerin Getirilmesi.. */
        $item = $this->football_category_model->get(
            array(
                "id"    => $id,
            )
        );
    ...
    public function update($id){
        ...
        if($validate){
            ...
            /** Tablodan Verilerin Getirilmesi.. */
            $viewData->item = $this->football_category_model->get(
                array(
                    "id"    => $id,
                )
            );
    ...
    public function isActiveSetter($id){
        ...
        if($id){
            ...
            $this->football_category_model->update(
                array(
                    "id"    => $id
                ),
                array(
