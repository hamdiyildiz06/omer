                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="footer-content">
                            <div class="logo-footer"><img id="logo-footer" src="<?php echo get_picture("settings_v", $settings->logo, "200x74"); ?>" alt="<?php echo $settings->company_name; ?>"></div>
                            <p>
    ...
    <div class="subfooter">
        <div class="container">
            <div class="subfooter-inner">
                <div class="row">
                    <div class="col-md-12">
                        <p class="text-center">Tüm Hakları Saklıdır © <?php echo date("Y"); ?> CMS by <a target="_blank" href="https://www.yildizturk.com">YildizTurk</a>. </p>
                    </div>
                </div>
            </div>
        </div>
